...
Повториои команду ```postconf myorigin``` и убедились, что замена параметра была произведена ([рис. @fig-013])
...
![Все параметры с значением, отличным от значения по умолчанию](image/лаба8_16.png){#fig-016 width=70%}
...
Сообщение доставлено успешно. Вывод основан на строке лога: ```Oct 19 17:07:49 server postfix/local[11192]: 47546235E86F: to<eavernikovskaya@server.eavernikovskaya.net>, relay=local, delay=0.08, delays=0.05/0.02/0/0.01, dsn=2.0.0, status=sent (delivered to mailbox)```
...
$ORIGIN .
$TTL 86400	; 1 day
eavernikovskaya.net	IN SOA	eavernikovskaya.net. server.eavernikovskaya.net. (
				2025091616 ; serial
				86400      ; refresh (1 day)
				3600       ; retry (1 hour)
			...
			NS	eavernikovskaya.net.
			A	192.168.1.1
			MX 10	mail.eavernikovskaya.net.
...
![Редактирование файла прямой DNS-зоны](image/лаба8_43.png){#fig-043 width=70%}
...
$ORIGIN .
$TTL 86400	; 1 day
1.168.192.in-addr.arpa	IN SOA	1.168.192.in-addr.arpa. server.eavernikovskaya.net. (
				2025091611 ; serial
				86400      ; refresh (1 day)
				3600       ; retry (1 hour)
				604800     ; expire (1 week)
...
1			PTR	server.eavernikovskaya.net.
			PTR	ns.eavernikovskaya.net.
			PTR	dhcp.eavernikovskaya.net.
			PTR	www.eavernikovskaya.net.
30			PTR	client.eavernikovskaya.net.
			DHCID	( AAEBZz0V+2znOOiQhKjraGVJGIC+vNR42A5PSQ44jxYr
				9w0= ) ; 1 1 32
1			PTR	mail.eavernikovskaya.net.
```

![Редактирование файла обратной DNS-зоны](image/лаба8_44.png){#fig-044 width=70%}
...
Сообщение было успешно отправлено. После настройки MX-записи в DNS система стала использовать корректный механизм маршрутизации почты через почтовый сервер mail.eavernikovskaya.net, а не прямое обращение к домену.
...
![Редактирование файла mail.sh на сервере](image/лаба8_54.png){#fig-054 width=70%}
...
![Редактирование файла Vagrantfile раздела конфигурации для сервера](image/лаба8_57.png){#fig-057 width=70%}
...
![Редактирование файла Vagrantfile раздела конфигурации для клиента](image/лаба8_58.png){#fig-058 width=70%}

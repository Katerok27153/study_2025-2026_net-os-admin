...
![Рабочий каталог с проектом](image/лаба16_1.png){#fig-001 width=70%}
...
![Перезапуск fail2ban (1)](image/лаба16_9.png){#fig-009 width=70%}

Посмотрели журнал событий: ```tail -f /var/log/fail2ban.log``` ([рис. @fig-010])

![Просмотр журнала событий fail2ban (2)](image/лаба16_10.png){#fig-010 width=70%}
...
![Редактирование файла /etc/fail2ban/jail.d/customisation.local (2)](image/лаба16_11.png){#fig-011 width=70%}

Перезапустили fail2ban: ```systemctl restart fail2ban``` ([рис. @fig-012])

![Перезапуск fail2ban (2)](image/лаба16_12.png){#fig-012 width=70%}
...
![Перезапуск fail2ban (3)](image/лаба16_15.png){#fig-015 width=70%}
...
![Статус fail2ban](image/лаба16_17.png){#fig-017 width=70%}
...
![установка максимального количества ошибок для SSH](image/лаба16_19.png){#fig-019 width=70%}
...
![Разблокировка IP-адреса клиента](image/лаба16_23.png){#fig-023 width=70%} 
...
![Перезапуск fail2ban (4)](image/лаба16_26.png){#fig-026 width=70%}
...
Вновь попытались войти с клиента на сервер с неправильным паролем и посмотрели статус защиты SSH ([рис. @fig-028]), ([рис. @fig-029])
